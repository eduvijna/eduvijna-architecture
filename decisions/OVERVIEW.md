...
| [ADR-AIEOS-046R1](ADR-AIEOS-046R1-aieos-production-event-plane-multi-domain-publisher-scope-revision.md) | AIEOS Production Event Plane Multi-Domain Publisher Scope Revision (Frozen / Approved — Founder approved 2026-08-31; CURRENT EVENT PUB closed set `io.eduvijna.aieos.content.>` + `io.eduvijna.aieos.teaching.>`; no platform-wide `io.eduvijna.aieos.>` publisher wildcard; narrow forward revision of ADR-AIEOS-046 A46-INV-03 only; does not authorize Infrastructure/Backend implementation or production mutation; TOS-DEV06-I03 NOT AUTHORIZED) |
