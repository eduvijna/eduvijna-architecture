...
| [ADR-AIEOS-056](ADR-AIEOS-056-aieos-improve-remediation-authority.md) | AIEOS Improve & Remediation Authority (Proposed / Freeze Candidate v1.0.1 — TOS-DEV09; OPTION B TeachingWork + `remediate_class` + immutable remediation origin with `source_class_result_level_snapshot`; class-level only; **DEV09 implementation not authorized**) |
