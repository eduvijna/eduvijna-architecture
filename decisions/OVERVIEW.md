...
| [ADR-AIEOS-053](ADR-AIEOS-053-aieos-teaching-assignment-classroom-delivery-authority.md) | AIEOS Teaching Assignment & Classroom Delivery Authority (Proposed / Freeze Candidate — TOS-DEV06; Publication ≠ Assignment; TeachingAssignment intent SoR; exact ContentVersion bind; ClassRef via School Context; command Idempotency-Key; no LMS delivery-attempt persistence in DEV06 core; architecture freeze ≠ implementation) |
