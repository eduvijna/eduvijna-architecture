...
| [ADR-AIEOS-045](ADR-AIEOS-045-aieos-dispatcher-tenant-candidate-discovery-authority.md) | AIEOS Dispatcher Tenant-Candidate Discovery Authority (**Proposed / not yet frozen** — pending-work candidate discovery; dedicated NOBYPASSRLS candidate-reader boundary; no dispatcher BYPASSRLS; no cross-tenant payload visibility) |
