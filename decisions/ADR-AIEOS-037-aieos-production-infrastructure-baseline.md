...
| [ADR-AIEOS-039](ADR-AIEOS-039-aieos-asset-blobstore-provider-selection.md) | Later first-production BlobStore provider selection (MinIO AIStor); infrastructure invariants unchanged |
| [ADR-AIEOS-040](ADR-AIEOS-040-aieos-asset-blobstore-first-production-topology.md) | Later ADR-AIEOS-040 freezes first-production AIStor topology (8×1, EC:3); infrastructure invariants unchanged |
