...
| [ADR-AIEOS-040](ADR-AIEOS-040-aieos-asset-blobstore-first-production-topology.md) | Later ADR-AIEOS-040 freezes first-production AIStor topology (8×1, EC:3); this ADR remains hosting-only |
