...
| [ADR-AIEOS-056](../decisions/ADR-AIEOS-056-aieos-improve-remediation-authority.md) — Improve & Remediation Authority (TOS-DEV09) | **Proposed / Freeze Candidate** | TOS-DEV09A accepted; TOS-DEV09P1 design + adversarial validation deposited; OPTION B TeachingWork + `remediate_class` + immutable remediation origin; class-level only; **Founder freeze not granted**; **DEV09-I01+ NOT AUTHORIZED** |
